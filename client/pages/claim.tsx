...
import { CLAIM_TOKEN_CONTRACT_ADDRESS, CLAIM_TOKEN_IMAGE } from "../constants/addresses";
...
export default function ClaimPage() {
    ...
    return (
        <Container maxW={"1440px"} h={"80vh"} >
            <SimpleGrid columns={2} spacing={10} h={"100%"} justifyContent={"center"} alignItems={"center"}>
                <Flex>
                    <MediaRenderer
                        ...
                        <Box>
                            <Web3Button
                                ...
                                onSuccess={() => toast({
                                    ...
                                    description: `You have successfully claimed ${claimAmount} tokens!`,
                                    status: 'success',
                                    duration: 9000,
                                    isClosable: true,
                                })}
